...
3. Update forward the container port to a host in run_kubernetes.sh

4. After you’ve called run_kubernetes.sh, and a pod is up and running, make a prediction using a separate terminal tab and run
`./make_prediction.sh`
